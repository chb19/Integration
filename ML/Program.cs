...
namespace ML
{
    class Program
    {
        ...
        public static (IDataView training, IDataView test) LoadData(MLContext mlContext)
        {
            ...
            IDataView trainingDataView = mlContext.Data.LoadFromTextFile<NewsRating>(trainingDataPath, hasHeader: true, separatorChar: ',');
            IDataView testDataView = mlContext.Data.LoadFromTextFile<NewsRating>(testDataPath, hasHeader: true, separatorChar: ',');
        ...
        public static ITransformer BuildAndTrainModel(MLContext mlContext, IDataView trainingDataView)
        {
            ...
            IEstimator<ITransformer> estimator = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName: "userIdEncoded", inputColumnName: "userId")
                .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName: "NewsIdEncoded", inputColumnName: "NewsId"));
            // </SnippetDataTransformations>
            ...
            var options = new MatrixFactorizationTrainer.Options
            {
                ...
                MatrixRowIndexColumnName = "NewsIdEncoded",
        ...
        public static void UseModelForSinglePrediction(MLContext mlContext, ITransformer model)
        {
            ...
            var testInput = new NewsRating { userId = 6, NewsId = 10 };
            ...
            {
                Console.WriteLine("News " + testInput.NewsId + " is recommended for user " + testInput.userId);
            }
            else
            {
                Console.WriteLine("News " + testInput.NewsId + " is not recommended for user " + testInput.userId);
            }
            // </SnippetPrintResults>
        }
